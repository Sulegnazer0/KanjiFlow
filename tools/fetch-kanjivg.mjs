...
kanji de nivel N5/N4/N3 usados en este proyecto. Cualquier dato derivado de estos
...
async function main() {
    ...
    if (supportedKanji.length === 0) {
        console.error("No se encontraron kanji N5/N4/N3 en datos.csv");
        process.exit(1);
    }

    if (!existsSync(OUTPUT_DIR)) await mkdir(OUTPUT_DIR, { recursive: true });

    console.log(`Descargando ${supportedKanji.length} SVG de KanjiVG (kanji N5/N4/N3)...`);
