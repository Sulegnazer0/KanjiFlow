...
4. `CHANGELOG.md` y el número de versión (`APP_VERSION`, `package.json`, `service-worker.js`) se actualizan solo al fusionar a `main` / cortar una versión publicable, no en cada commit de una rama de feature en progreso.
